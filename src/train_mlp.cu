...
void do_one_epoch2(MLP<float>& mlp, SGD<float>& sgd, Tensor<float>& images, const Tensor<char>& targets, 
...
void train_and_test2(int epochs, int batch_size, int hidden_dim, int n_layers)
{
